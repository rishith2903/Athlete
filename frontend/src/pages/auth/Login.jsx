...
import { Eye, EyeOff, Mail, Lock, Loader2, Play, Sun, Moon } from 'lucide-react';
...
const Login = () => {
  ...
  return (
    <div className={cn(
      "min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 relative transition-colors duration-300",
