...
public class PoseController {
    ...
    public Mono<ResponseEntity<Map<String, Object>>> checkExerciseForm(
            ...
            @RequestParam(value = "skillLevel", defaultValue = "beginner") String skillLevel,
        ...
        log.info("Processing form check for user {} - exercise: {}, skill: {}, file: {}, size: {} bytes",
                user.getId(), exerciseType, skillLevel, file.getOriginalFilename(), file.getSize());
